...
const Navbar = () => {
    ...
    return (
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <img src="/Users/nadellanikhila/Desktop/Airbnb-Clone-master 2/public/images" width="102" height="80"  alt=""/>
          ...
          <div style='Padding-right: 20px;'><button id="logout" class="btn btn-primary btn-primary-f" type="button"  aria-expanded="false" style='font-size:18px;background-color:white;color:red' >Logout</button></div>
